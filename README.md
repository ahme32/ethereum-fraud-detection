...
🔗 **[Try the app here](https://ethereum-fraud-detection-o6svcvxcehhckqjwf44h7i.streamlit.app)**

🐙 **[GitHub Repo](https://github.com/ahme32/ethereum-fraud-detection)**
...
```bash
# 1. Clone the repo
git clone https://github.com/ahme32/ethereum-fraud-detection.git
